    ...
    def process_event(self, cloud_event: cloudevent.CloudEvent) -> None:
        ...
        with with_tracer_context(traceparent, "evaluate_rules", __name__):
            ...
            if not evaluated_payload:
                logger.error(
                    "Evaluation returned no payload for feed %s and segment %s. Skipping.",
                    new_audio.feed_id,
            ...
            try:
                ...
                logger.warning(
                    "Transcript already exists for segment %s which indicates we already processed this segment. Continuing.",
