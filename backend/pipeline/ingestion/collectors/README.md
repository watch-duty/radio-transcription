...
> 1. **`bcfy_feeds` vs `bcfy_calls`**: `bcfy_feeds` represents continuous audio streams handled by [`icecast_collector.py`](file:///usr/local/google/home/arobee/Projects/gh/radio-transcription/backend/pipeline/ingestion/collectors/icecast/icecast_collector.py). Do not confuse it with `bcfy_calls` (Broadcastify Calls), which is a separate REST-based polling collector ([`bcfy_calls_collector.py`](file:///usr/local/google/home/arobee/Projects/gh/radio-transcription/backend/pipeline/ingestion/collectors/bcfy_calls/bcfy_calls_collector.py)) capturing discrete pre-segmented calls that do **NOT** pass through Dataflow segmentation.
...
| :--- | :--- | :--- | :--- |
| [`icecast_collector.py`](file:///usr/local/google/home/arobee/Projects/gh/radio-transcription/backend/pipeline/ingestion/collectors/icecast/icecast_collector.py) | `bcfy_feeds` *(primary)*, `icecast` *(future)* | Continuous Icecast-protocol streams | **YES** |
| [`bcfy_calls_collector.py`](file:///usr/local/google/home/arobee/Projects/gh/radio-transcription/backend/pipeline/ingestion/collectors/bcfy_calls/bcfy_calls_collector.py) | `bcfy_calls` | Discrete call REST polling API | **NO** |
| [`openmhz/collector.py`](file:///usr/local/google/home/arobee/Projects/gh/radio-transcription/backend/pipeline/ingestion/collectors/openmhz/collector.py) | `openmhz` | Discrete call polling API | **NO** |
| [`fire_notifications/collector.py`](file:///usr/local/google/home/arobee/Projects/gh/radio-transcription/backend/pipeline/ingestion/collectors/fire_notifications/collector.py) | `fire_notifications` | Event notification stream | **NO** |
| `echo/main.py` | `echo` | Archival push (Cloud Function) | **NO** |
