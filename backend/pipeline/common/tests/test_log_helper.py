...
class TestLogging(TestCase):
    ...
    @mock.patch("backend.pipeline.common.tracing_utils.CloudMonitoringMetricsExporter")
    ...
    def test_setup_logging_gcp(
        self, mock_cloud_logging, mock_trace_exporter, mock_metrics_exporter, mock_set_provider
    ) -> None:
