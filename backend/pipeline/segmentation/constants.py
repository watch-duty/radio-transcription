...
# DoFns. Keeps bundle execution time at ~1.5 s (5 × ~0.3 s/chunk) to ensure reliable
# checkpoints well under Windmill's hard 300-second lease limit, allowing self-chaining
# state timers to execute in parallel across worker leases.
