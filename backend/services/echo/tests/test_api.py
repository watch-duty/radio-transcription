...
class TestEchoAPI(unittest.TestCase):
    ...
    def test_missing_payload(self, mock_container):
    ...
    @patch("backend.services.echo.main.container")
    def test_missing_source_feed_id(self, mock_container):
        mock_request = MagicMock()
    ...
    @patch("backend.services.echo.main.container")
    def test_exists(self, mock_container):
    ...
    @patch("backend.services.echo.main.container")
    def test_does_not_exist(self, mock_container):
        mock_backend = MagicMock()
    ...
    @patch("backend.services.echo.main.container")
    def test_backend_error(self, mock_container):
        mock_backend = MagicMock()
        mock_backend.verify_directory_exists.side_effect = Exception("API error")
        mock_container.get_echo_backend.return_value = mock_backend
